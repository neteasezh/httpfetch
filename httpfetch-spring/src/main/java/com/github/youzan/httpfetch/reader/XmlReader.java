package com.github.youzan.httpfetch.reader;
        ...
        try {
            ...
            if (resources != null && resources.length > 0) {
                for (Resource resource : resources) {
                    this.read(resource.getInputStream());
                }
            }
        } catch (Exception e) {
            LOGGER.error("读取SourceReader配置信息出错! location [{}]", location, e);
